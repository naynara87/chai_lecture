...
const SentencesOption = styled.button<SentencesOptionProps>`
  ...
  background-color: ${(props) =>
    props.bgColor || colorPalette.disableBackground};
...
const StudySentencesWithVocabulary = ({
  ...
  const [currentBubbleSentenceIndex, setCurrentBubbleSentenceIndex] =
    useState(0);
      ...
      return (
        <>
          <HtmlContentComponent
            html={texts[currentSentenceIndex]}
            customCss={htmlCss}
          />
          <HtmlContentComponent
            html={pronunciations[currentSentenceIndex]}
            customCss={htmlCss}
          />
