...
import { TemplateQuestionData } from "../../../core";

interface ComponentProblemCommentaryProps {
  quizPageIdx: number;
  quizPageData: TemplateQuestionData;
}
    ...
    <div className="problem-commentary-wrapper">
      ...
      <div className="problem-commentary-wrap">
        <h3 className="com-ttl">
          <b>{`${quizPageIdx + 1}번`}</b> <img src={IconWrong} alt="오답" />
        </h3>
        <div className="tab-iframe-wrap">
          ...
          <div className="tab-conts-wrapper">
            <iframe
              src={quizPageData.contents.data.iframeUrl}
              title={quizPageData.contents.id.toString()}
              width="100%"
              height="100%"
              frameBorder="0"
              allowFullScreen
