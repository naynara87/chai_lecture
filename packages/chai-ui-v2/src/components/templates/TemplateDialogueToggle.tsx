...
import { TemplateConversationData, TemplateProps } from "../../core";
...
interface TemplateDialogueToggleProps extends TemplateProps {}

const TemplateDialogueToggle = ({
  template,
  setPageCompleted,
}: TemplateDialogueToggleProps) => {
  const thisTemplate = template as TemplateConversationData;
    ...
    <DialogueContainer className="layout-panel-wrap grid-h-3-7">
      <div className="layout-panel side-panel">
        <div className="cont-info-wrap">
          ...
          {/* end 말풍선 캐릭터 */}
          {/* ComponentVocaNote */}
          {/* <ConversationWordListComponent contents={thisTemplate.leftContents} /> */}
...
export default TemplateDialogueToggle;
