...
const ArrowRight = ({ customCss, disabled }: ArrowRightProps) => {
  return (
    <IconWrapper customCss={customCss}>
      ...
      >
        <path
          ...
          fill={disabled ? colorPalette.disableText : colorPalette.deepBlue}
          stroke={disabled ? colorPalette.disableText : colorPalette.deepBlue}
        />
      </svg>
    </IconWrapper>
  );
