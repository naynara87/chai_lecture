...
interface ArrowRightNavyProps {
  customCss?: SerializedStyles;
  disabled?: boolean;
}
const ArrowRightNavy = ({ customCss, disabled }: ArrowRightNavyProps) => {
  console.log("disabled", disabled);
  return (
    <IconWrapper customCss={customCss}>
      <svg
        width="14"
        height="22"
        viewBox="0 0 14 22"
      ...
      >
        <path
          ...
          fill={disabled ? colorPalette.disableText : "#40476B"}
          stroke={disabled ? colorPalette.disableText : "#40476B"}
        />
      </svg>
    </IconWrapper>
  );
